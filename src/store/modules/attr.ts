...
import { reqGetAttr, reqCategory1, reqCategory2, reqCategory3, reqAddAttr } from '@/api/shop/attr/index'
...
const useAttrStore = defineStore('attr', {
    ...
    actions: {
        ...
        // 获取属性列表
        async getAttr() {
            const res: attrType = await reqGetAttr(this.categoryId1, this.categoryId2, this.categoryId3)
